...
function generateIntelligentTitle(context, conversationContent) {
    const { project_name, project_component, feature_name, phase, status, clustering_hints } = context;
...
// EXPORTS
// ============================================================================
export { extractProjectContext, generateIntelligentTitle, extractProgressIndicators, extractRelationships };
//# sourceMappingURL=intelligent-memory.js.map