#!/usr/bin/env python3
"""
PUO Memo MCP Server - Fixed with Connection Pooling
Properly handles async operations without event loop conflicts
"""
import asyncio
import json
import sys
...
# Import our pooled memory system
...
class PuoMemoServer:
    """MCP Server for PUO Memo with connection pooling"""
    
    def __init__(self):
        self.puo = PuoMemoPooled()
        self.server = Server("puo-memo-pooled")
    ...
    async def initialize(self):
        ...
        logger.info("✅ PUO Memo MCP Server initialized with connection pooling")
    ...
    def get_tools(self) -> List[Tool]:
        ...
        return [
            ...
            Tool(
                name="ask_memory",
                description="❓ Ask a question about your memories",
                inputSchema={
                    "type": "object",
                    "properties": {
                        "question": {
            ...
            Tool(
                ...
                inputSchema={
                    ...
                    "properties": {
                        "context": {
                            "type": "string",
                            "description": "Name of the project context to switch to"
                        }
                    },
                    "required": ["context"]
                }
...
async def main():
    ...
    # Run the server
    try:
        logger.info("🚀 PUO Memo MCP Server - Fixed with Connection Pooling")
        logger.info("📝 8 essential memory tools available")
        logger.info("✨ Features:")
        logger.info("   - Connection pooling for concurrent operations")
        logger.info("   - Safe async handling")
